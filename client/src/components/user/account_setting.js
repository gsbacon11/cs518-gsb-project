            ...
            <div className={styles.mainFormUser}>
                <div className="text-left pb-5">
                    ...
                    <   input type="password" ref={refInputPassword} className={styles.inputText} value={password} onChange={e => setPassword(e.target.value)} placeholder="Password"/>
                        ...
                        <input type="password" ref={refInputPasswordRetyped} className={styles.inputText} value={passwordRetyped} onChange={e => setPasswordRetyped(e.target.value)} placeholder="Retype New Password"/>
                        ...
                        <button type="button" className={styles.mainPageButton}  onClick={onConfirm}>Confirm Password</button>
                        </div>
                    </div>
                </div>
            </div>
